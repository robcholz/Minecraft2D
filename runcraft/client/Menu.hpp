...
private:
	...
	SoundSliderWidget *settingVolumeSliderJukeboxNoteblocks = new SoundSliderWidget("jukebox_noteblocks_volume", 590, 80, true,
	...
	SoundSliderWidget *settingVolumeSliderHostileCreatures = new SoundSliderWidget("hostile_creatures_volume", 590, 80, true,
	                                                                               screenWidth / 2 - 620, 445);
	SoundSliderWidget *settingVolumeSliderFriendlyCreatures = new SoundSliderWidget("friendly_creatures_volume", 590, 80, true,
	...
	SoundSliderWidget *settingVolumeSliderAmbientEnvironment = new SoundSliderWidget("ambient_environment_volume", 590, 80, true,
