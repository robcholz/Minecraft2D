...
class MusicSoundEvent {
 public:
  ...
  sf::SoundBuffer& getSound() { return soundEvent->getSound(); }

  [[nodiscard]] int getMinDelay() const { return minDelay; }

  [[nodiscard]] int getMaxDelay() const { return maxDelay; }

  [[nodiscard]] bool getReplaceCurrentMusic() const {
