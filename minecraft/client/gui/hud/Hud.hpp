...
class Hud {
 protected:
   ...
   * @return
   */
  sf::Vector2f getCenter() { return worldAccess->getView().getCenter(); }
  ...
  [[nodiscard]] bool isOnScheduledUpdate() const {
  ...
  [[nodiscard]] HudPixelPosT getScreenCornerX() const { return x_pos; }

  [[nodiscard]] HudPixelPosT getScreenCornerZ() const { return z_pos; }
