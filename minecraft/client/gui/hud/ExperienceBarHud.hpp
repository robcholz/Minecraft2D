...
namespace hud {
	...
	public:
		...
		void render() override {
			RenderSystem::render(emptyExperienceBarSprite);
		}
	...
	private:
		...
		void setPosition(HudPixelPosT x, HudPixelPosT z) override {
			Hud::setPosition(x, z);
			emptyExperienceBarSprite.setPosition((float) getScreenCornerX(), (float) getScreenCornerZ());
		}
		...
		void updatePosition() override {
			auto pos = convertToPixPos(screenWidth / 2.0f - mapTo((182 / 2)), screenHeight - mapTo((21 + 8)));
