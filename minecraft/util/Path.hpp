...
#ifndef MINECRAFT_PATH_HPP
#define MINECRAFT_PATH_HPP
...
class Path {
 ...
 public:
  ...
  static inline String widgetPath =
      rootDirectory + "/assets/textures/gui/widgets.png";
  static inline String currentLangPath =
      rootDirectory + "/assets/lang/en-us.json";
  static inline String optionsPath = rootDirectory + "/assets/options.json";
  static inline String currentPlayerPath =
      rootDirectory + "/assets/textures/player/steve.png";
