...
class Math {
 ...
 public:
  ...
  static constexpr float SQUARE_ROOT_OF_TWO =
      boost::math::constants::root_two<float>();
  static constexpr float SQUARE_ROOT_OF_THREE =
      boost::math::constants::root_three<float>();
  static constexpr float DEGREES_TO_RADIANS =
      (float)(boost::math::constants::pi<double>() / 180.0f);
  ...
  static int fastFloor(double value) { return (int)(value + 1024.0) - 1024; }
...
bool static checkVectorBoundary(int x,
                                int y,
                                int left,
                                int top,
                                int width,
